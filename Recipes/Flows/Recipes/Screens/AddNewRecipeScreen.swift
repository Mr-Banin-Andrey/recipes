...
struct AddNewRecipeScreen: View {
            ...
            ScrollView(.vertical, showsIndicators: false) {
                VStack(spacing: 16) {
                    ...
                    VStack(spacing: 0) {
                        ...
                        TextField("Введите текст", text: $recipesStore.name)
                    ...
                    VStack(spacing: 0) {
                        HStack {
                            ...
                            Menu {
                                Picker(selection: $recipesStore.menuSection) {
                                ...
                                HStack {
                                    Text(recipesStore.menuSection.localizedDescription)
                    ...
                    VStack(spacing: 0) {
                        ForEach($recipesStore.ingredients) { ingredient in
                            AddIngredientView(
                    ...
                    TextEditor(text: $recipesStore.instruction)
                        .padding(5)
                        .frame(height: 180)
